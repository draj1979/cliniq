...
const TRUSTED = [
  { name: "Sunrise Clinic", sub: "Pune" },
  { name: "Asha Multispeciality", sub: "Nashik" },
  { name: "Dr. Rao's Clinic", sub: "Hyderabad" },
  { name: "Lakeview Medical Centre", sub: "Bhopal" },
  { name: "Sanjeevani Polyclinic", sub: "Indore" },
  { name: "Wellspring Family Practice", sub: "Kochi" },
];
...
export default function Home() {
  return (
    <div className="min-h-screen w-full bg-bone text-fg2">
      ...
      <nav className="sticky top-0 z-50 border-b border-transparent bg-bone/85 backdrop-blur-md" style={{ borderColor: "var(--border)" }}>
        <div className="mx-auto flex h-16 max-w-[1240px] items-center justify-between px-6 md:px-10">
          ...
          <div className="flex items-center gap-2">
            <a
              href="#waitlist"
              className="focus-ring inline-flex items-center rounded-[6px] px-4 py-2 text-[14px] font-medium text-bone transition-colors"
      ...
      <section className="border-y bg-bone-50" style={{ borderColor: "var(--border)" }}>
        <div className="mx-auto max-w-[1240px] px-6 py-10 md:px-10">
          <div className="text-center text-[12px] tracking-[-0.005em] text-fg3">
            Trusted by independent practitioners and small clinics across India
          </div>
      ...
      <section
        id="pricing"
        className="scroll-mt-20 mx-auto max-w-[1240px] border-t px-6 py-24 md:px-10 md:py-32"
        style={{ borderColor: "var(--border)" }}
      >
        <div className="mb-14 max-w-[760px]">
          ...
          {TIERS.map((t) => {
            ...
            return (
              ...
              >
                ...
                <a
                  href="#waitlist"
                  className={`focus-ring mt-auto inline-flex items-center justify-center rounded-[8px] px-5 py-3 text-center text-[14px] font-medium transition-colors`}
                  style={
                    t.variant === "primary"
      ...
      >
        <div className="mx-auto max-w-[1240px] px-6 py-24 text-center md:px-10 md:py-32">
          ...
          <div className="mt-9 flex justify-center">
            <WaitlistForm source="ClinIQ" variant="dark" />
          </div>
        </div>
      </section>
      ...
      >
        <div className="mx-auto flex max-w-[1240px] flex-col items-start justify-between gap-6 px-6 py-14 md:flex-row md:items-center md:px-10">
          ...
          <a
            href="#waitlist"
            className="focus-ring inline-flex shrink-0 items-center rounded-[8px] px-6 py-3.5 text-[15px] font-medium text-white transition-colors"
            style={{ background: "var(--ember-500)" }}
          >
            Join the waitlist
          </a>
