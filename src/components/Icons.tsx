 ...
 * Matches the ClinIQ design-system spec without adding the
...
export function Stethoscope({ size = 18, className, strokeWidth = 1.5 }: Props) {
  return (
    <svg {...base(size, strokeWidth, className)}>
      <path d="M4.8 2.3A.3.3 0 1 0 5 2a.3.3 0 0 0-.2.3M8 15a6 6 0 0 0 12 0v-3" />
      <path d="M11 3v5a4 4 0 0 1-4 4 4 4 0 0 1-4-4V3M11 3H9M3 3H5" />
